-- mod made by tost
-- text
-- FARKLI UI KÜTÜPHANESİ ILE YENIDEN YAZILDI

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/wally-rblx/LinoriaLib/main/LinoriaLib.lua"))()

local win = Library:CreateWindow("MM2 CHEAT v4.0", true)
